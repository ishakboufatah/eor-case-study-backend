...
class CaseStudies(models.Model):
    ...
    EOR_Type = models.ForeignKey('EORsubType', models.DO_NOTHING, db_column='EOR_Type',related_name='EORType')
    Flood_Type = models.CharField(max_length=15, choices=Flood_Type_CHOICES)
