...
class JoinCaseStudies(models.Model):
    ...
    pool_name = models.CharField(max_length=50,blank=True)
    summary = models.TextField(max_length=10000,blank=True)
    image1 = models.CharField(max_length=50,blank=True)
    image2 = models.CharField(max_length=50,blank=True)
    image3 = models.CharField(max_length=50,blank=True)
    image4 = models.CharField(max_length=50,blank=True)
    image5 = models.CharField(max_length=50,blank=True)
    image6 = models.CharField(max_length=50,blank=True)
    formation = models.CharField(max_length=50,null=True,blank=True)
